...
import { BookOpen, ChevronRight, History, UploadCloud } from 'lucide-react';
...
export function WorkspaceEmptyState({ onUploaded, onOpenHistory }: Props) {
  ...
  const startCatalogCase = (caseId: string) => {
    ...
    router.push(
      ...
      `/student/visual-qa/workspace?caseId=${encodeURIComponent(caseId)}&flow=catalog`,
    ...
    <div className="flex min-h-0 flex-1 flex-col overflow-y-auto bg-[radial-gradient(circle_at_top_left,_rgba(59,130,246,0.10),_transparent_35%),linear-gradient(180deg,_rgba(255,255,255,0.98),_rgba(248,250,252,1))]">
      ...
      <section className="px-6 py-4 lg:px-10 lg:py-6">
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="medical-bento-card p-6 lg:p-8">
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              ...
              {onOpenHistory ? (
                ...
                <Button
                  ...
                  className="rounded-2xl border-slate-200/70 bg-white/90 shadow-sm"
      ...
      <section className="px-6 pb-8 lg:px-10 lg:pb-10">
